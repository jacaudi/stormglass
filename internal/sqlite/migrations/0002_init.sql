...
CREATE INDEX IF NOT EXISTS idx_obs_serial_time ON stormglass_observations(serial_number, timestamp);
...
CREATE INDEX IF NOT EXISTS idx_obs_time ON stormglass_observations(timestamp);
